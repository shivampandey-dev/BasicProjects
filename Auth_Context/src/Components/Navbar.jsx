...
function Navbar() {
    ...
    const { user, isLogin, setIsLogin } = useContext(UserloginContext)
        ...
        <nav className="relative bg-gray-800/50 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="hidden sm:ml-6 sm:block">
                            <div className="flex space-x-4">
                                {isLogin ? <p className="cursor-pointer rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white" onClick={(e) => setIsLogin(false)}>Logout</p> : <p className="cursor-pointer rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white">Welcome</p>}
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        {isLogin ? <p className="text-white">{user}</p> : <NavLink to="/login" className="text-gray-300 hover:bg-white/5 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Login</NavLink>}
            ...
            <el-disclosure id="mobile-menu" hidden className="block sm:hidden">
                <div className="space-y-1 px-2 pt-2 pb-3">
                    ...
                    <a href="#" aria-current="page" className="block rounded-md bg-gray-950/50 px-3 py-2 text-base font-medium text-white">Logout</a>
